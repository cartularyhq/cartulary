...
`docs/architecture/free-core-architecture.md` and the outstanding work in
...
Details: `docs/architecture/ash-domain-backbone.md`.
...
Details: `docs/architecture/transactional-writes-audit-jobs.md`.
...
Details: `docs/architecture/identity-tenancy-rbac.md`.
...
Details: `docs/architecture/gate-a-b-governance.md`.
...
Details: `docs/architecture/model-layer-structured-extraction.md`.
...
Details: `docs/architecture/documents-connectors-sync.md`.
...
Details: `docs/architecture/retrieval-entity-context.md`.
...
Details: `docs/architecture/skill-readiness-procedural-memory.md`.
...
Details: `docs/architecture/portability-packaging-operations.md` and
`docs/operations/`.
...
Details: `docs/architecture/evaluation-ci-release-readiness.md` and
...
- `/governance` LiveView, password sessions only
- `/mcp` AshAi MCP endpoint

All `/api/v1` routes require a password JWT or an agent API key.
...
- **Integration surfaces are partial.** The Phoenix JSON controller, the
  ...
  `docs/eval/surface-contract-inventory.json` marks the missing surfaces
